...
- `AQUILA_SAGITTARIUS_TOKEN`: Set the same token here if you want the global runtime to connect right away. If you leave it blank, you can set it up runtime later, follow [Setup additional runtimes](#setup-additional-runtimes-optional) instructions.
...
## Setup additional runtimes (optional)
<Steps>
<Step>
